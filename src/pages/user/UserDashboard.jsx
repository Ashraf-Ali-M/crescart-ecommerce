    ...
    return (
        <Layout>
            <div className=" container mx-auto px-4 py-5 lg:py-8">
                ...
                <div className="top ">
                    {/* main  */}
                    <div className=" bg-blue-50 py-5 rounded-xl border border-blue-400">
                        {/* image  */}
                            ...
                            return (
                                <div key={index}>
                                    {order.cartItems.map((item, index) => {
                                        ...
                                        const { status } = order
                                        return (
                                            <div key={index} className="mt-5 flex flex-col overflow-hidden rounded-xl border border-blue-400 md:flex-row">
                                                {/* main 3  */}
                                                <div className="w-full border-r border-blue-400 bg-blue-50 md:max-w-xs">
                                                    {/* left  */}
                                                    <div className="p-8">
