    ...
    <Layout>
      <section className="py-5 lg:py-16 font-poppins dark:bg-gray-800">
        {loading ? (
          ...
          <>
            <div className="max-w-6xl px-4 mx-auto animate-fadeIn">
              <style jsx>{`
                @keyframes fadeIn {
                  from {
                    opacity: 0;
                ...
                <div className="w-full px-4 md:w-1/2">
                  <div className="lg:pl-20">
                    ...
                    <div className="flex gap-4 mb-6">
                      <button className="w-full px-4 py-3 text-center text-gray-100 bg-blue-900 border border-transparent dark:border-gray-700 hover:border-blue-500 hover:text-blue-900 hover:bg-blue-100 rounded-xl">
                        Buy now
                      </button>
                    </div>
                  </div>
